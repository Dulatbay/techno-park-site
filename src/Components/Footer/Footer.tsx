                ...
                <div className={`${styles.container}`}>
                    <div className={`${styles.footer__list}`}>
                        <div className={`${styles.footer__main}`}>
                            <div className={`${styles.footer__main_text}`}>
                                <ul>
                                    <li>
                                        <a href="tel:+7 727 307 95 65">
                                            <strong>+7 727 307 95 65</strong>
                                        </a>
                                    </li>
                                    <li>
                                        <a
...
"
                        ...
                        <div className="footer__side">
                            <ul
                                role="list"
                                className="footer__side_sociallinks"
                                aria-label="Соц. сети"
                                style={{ listStyle: 'none' }}
                            >
                                <li className="t-sociallinks__item t-sociallinks__item_telegram">
                                    <a
                                        href="https://t.me/sdu_technopark"
                                        target="_blank"
                                        rel="nofollow noopener"
                                        aria-label="sdu_technopark"
                                ...
                                <li className="t-sociallinks__item t-sociallinks__item_instagram">
                                    <a
                                        href="https://www.instagram.com/technopark_sdu?igshid=MzRlODBiNWFlZA%3D%3D"
                                        target="_blank"
                                        rel="nofollow noopener"
                                        aria-label="technopark_sdu"
                                        title="technopark_sdu"
                                        style={{
                                            width: '30px',
                                            height: '30px',
                                        }}
